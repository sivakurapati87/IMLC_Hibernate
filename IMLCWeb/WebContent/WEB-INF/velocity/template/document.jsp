			...
			<td colspan="2" align="center" width="100%"><table
							...
							<table style="width: 80%" border="0">
								...
								<tr>
												...
												<tr>
													<td class="width90"><div class="input-group"
															...
															<div angucomplete-alt class="lable16"
																placeholder="Document Code" pause="100"
																selected-object="selectedDocumentIdAction"
																local-data="documentJsonList" search-fields="documentId"
																id="documentId" initial-value="document"
																title-field="documentId" minlength="2"
									...
									<td align="right"><input placeholder="Document Name"
										...
										type="text" required=""
										ng-model="primary_Details_Obj.documentName"
										name="productId"></td>
								</tr>
								<tr style="height: 20px"></tr>
								<tr>
								...
								<tr>
									...
									<td align="right"><textarea rows="5" cols=""
											...
											ng-model="primary_Details_Obj.documentDescription"></textarea></td>
								</tr>
								<tr style="height: 20px"></tr>
							</table>
						</td>
					...
					<tr>
						<td colspan="4" align="right"
							...
							ui-sref="shipment_details" tooltip="Next"> <i
				...
				<table border="0" width="100%"
					...
					<tr>
						...
						<td align="center"><input ng-model="search.documentName"
							class="width90"></td>
						<td align="center"><input ng-model="search.documentDescription"
							class="width90"></td>
					</tr>
					<tr
