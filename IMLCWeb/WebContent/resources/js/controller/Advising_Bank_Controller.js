...
App.controller('Advising_Bank_Controller', ['$cookies','$http','$scope','$rootScope','Global_Parameter_Service','$location','$timeout', function($cookies,$http,$scope,$rootScope,Global_Parameter_Service,$location,$timeout) {
