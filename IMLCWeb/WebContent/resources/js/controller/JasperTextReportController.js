...
App.controller('JasperTextReportController', ['$timeout','$scope','Excel','$http','$cookies','$rootScope', function($timeout,$scope,Excel,$http,$cookies,$rootScope) {
	...
	$scope.loader = {
	 ...
	 //This is the init method
	  $scope.init = function(){
		...
		$scope.primaryData = $rootScope.transactionData;
		$scope.hideloader();
		 }else{
