...
public class GlobalParameterJson {
	...
	public String getStrEffective_From() {
		return strEffective_From;
	}

	public void setStrEffective_From(String strEffective_From) {
		this.strEffective_From = strEffective_From;
	}
